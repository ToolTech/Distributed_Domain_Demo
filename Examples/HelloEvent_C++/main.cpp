...
class EventSender : public gzDistClientInterface , public gzReference
{
public:
...
class EventReceiver : public gzDistClientInterface , public gzReference
{
public:
...
GZ_DECLARE_REFPTR(EventReceiver);
...
int main(int argc, char* argv[])
{
    ...
    EventReceiverPtr receiver = new EventReceiver;

    // Create sender client
    EventSenderPtr sender = new EventSender;
